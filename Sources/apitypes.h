...
// Functions to return the major + minor version of the core code. Note that
// this is independent of the UI version.
...
typedef int (*ms_contains_instrument)(const char *mpe_id,
                                      const char *musicxml_id);
typedef int (*ms_get_matching_instrument_id)(const char *pack,
                                             const char *name);
typedef ms_InstrumentList (*ms_get_instrument_list)();
typedef ms_InstrumentList (*ms_get_matching_instrument_list)(
    const char *mpe_id, const char *musicxml_id);
typedef ms_InstrumentInfo (*ms_InstrumentList_get_next)(
    ms_InstrumentList instrument_list);
...
typedef ms_Result (*ms_MuseSampler_init)(ms_MuseSampler ms, double sample_rate,
                                         int block_size, int channel_count);
...
typedef ms_Track (*ms_MuseSampler_add_track)(ms_MuseSampler ms,
                                             int instrument_id);
typedef ms_Result (*ms_MuseSampler_finalize_track)(ms_MuseSampler ms,
                                                   ms_Track track);
typedef ms_Result (*ms_MuseSampler_clear_track)(ms_MuseSampler ms,
                                                ms_Track track);

typedef ms_Result (*ms_MuseSampler_add_track_note_event)(ms_MuseSampler ms,
                                                         ms_Track track,
                                                         ms_NoteEvent evt);
// Added in 0.3
typedef ms_Result (*ms_MuseSampler_add_track_note_event_2)(ms_MuseSampler ms,
                                                           ms_Track track,
                                                           ms_NoteEvent_2 evt);
// Added in 0.4
typedef ms_Result (*ms_MuseSampler_add_track_note_event_3)(ms_MuseSampler ms,
                                                           ms_Track track,
                                                           ms_NoteEvent_3 evt);
typedef ms_Result (*ms_MuseSampler_add_track_dynamics_event)(
    ms_MuseSampler ms, ms_Track track, ms_DynamicsEvent evt);
// Added in 0.5
typedef ms_Result (*ms_MuseSampler_add_track_note_event_4)(ms_MuseSampler ms,
                                                           ms_Track track,
                                                           ms_NoteEvent_3 evt,
                                                           long long &event_id);
// Added in 0.4
typedef ms_Result (*ms_MuseSampler_add_track_dynamics_event_2)(
    ms_MuseSampler ms, ms_Track track, ms_DynamicsEvent_2 evt);
typedef ms_Result (*ms_MuseSampler_add_track_pedal_event)(ms_MuseSampler ms,
                                                          ms_Track track,
                                                          ms_PedalEvent evt);
// Added in 0.4
typedef ms_Result (*ms_MuseSampler_add_track_pedal_event_2)(
    ms_MuseSampler ms, ms_Track track, ms_PedalEvent_2 evt);

typedef int (*ms_MuseSampler_is_ranged_articulation)(ms_NoteArticulation);
typedef ms_Result (*ms_MuseSampler_add_track_event_range_start)(
    ms_MuseSampler, ms_Track, int voice, ms_NoteArticulation);
typedef ms_Result (*ms_MuseSampler_add_track_event_range_end)(
    ms_MuseSampler, ms_Track, int voice, ms_NoteArticulation);

// Added in 0.5
typedef ms_Result (*ms_MuseSampler_add_pitch_bend)(ms_MuseSampler ms,
                                                   ms_Track track,
                                                   ms_PitchBendInfo info);
typedef ms_Result (*ms_MuseSampler_add_vibrato)(ms_MuseSampler ms,
                                                ms_Track track,
                                                ms_VibratoInfo info);

typedef ms_Result (*ms_MuseSampler_start_audition_note)(
    ms_MuseSampler ms, ms_Track track, ms_AuditionStartNoteEvent evt);
// Added in 0.3
typedef ms_Result (*ms_MuseSampler_start_audition_note_2)(
    ms_MuseSampler ms, ms_Track track, ms_AuditionStartNoteEvent_2 evt);
typedef ms_Result (*ms_MuseSampler_stop_audition_note)(
    ms_MuseSampler ms, ms_Track track, ms_AuditionStopNoteEvent evt);
...
typedef ms_Result (*ms_MuseSampler_start_liveplay_note)(
    ms_MuseSampler ms, ms_Track track, ms_LivePlayStartNoteEvent evt);
// Added in 0.3
typedef ms_Result (*ms_MuseSampler_start_liveplay_note_2)(
    ms_MuseSampler ms, ms_Track track, ms_LivePlayStartNoteEvent_2 evt);
typedef ms_Result (*ms_MuseSampler_stop_liveplay_note)(
    ms_MuseSampler ms, ms_Track track, ms_LivePlayStopNoteEvent evt);

typedef ms_Result (*ms_MuseSampler_start_offline_mode)(ms_MuseSampler ms,
                                                       double sample_rate);
typedef ms_Result (*ms_MuseSampler_stop_offline_mode)(ms_MuseSampler ms);
typedef ms_Result (*ms_MuseSampler_process_offline)(ms_MuseSampler ms,
                                                    ms_OutputBuffer buffer);

typedef ms_Result (*ms_MuseSampler_process)(ms_MuseSampler, ms_OutputBuffer,
                                            long long samples);
